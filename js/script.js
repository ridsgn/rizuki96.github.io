...
function buttonAnim() {
    $("#about").velocity("transition.bounceUpIn")
        .mouseenter(function () {
            $(this).velocity({
                width: 110,
            });
...
function contact() {
    ...
    setTimeout(function () {
        $("#logo ul li a")
            .mouseover(function () {
                $(this).parent("li").addClass("fa-spin").siblings().removeClass("fa-spin");
            })
            .mouseleave(function () {
                $(this).parent("li").removeClass("fa-spin");
            })
    }, 1200);
}
...
function back() {
    ...
    $("#text").velocity({
        ...
        duration: 1000,
        complete: function () {
            $("#about").velocity("transition.whirlIn").css({
                "width": "135"
            });
        }
    });
